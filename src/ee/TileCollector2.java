...
public class TileCollector2 extends TileEE implements ISpecialInventory, ISidedInventory, IEEPowerNet {
  ...
  public void sendAllPackets(int i) {
    ...
    if (j == 0) {
      if (this.collectorSunTime <= 2400000 - i) {
  ...
  private int getSunTimeScaled(int i) {
    return this.collectorSunTime * i / 2400000;
  }
  ...
  public int getProduction() {
    return this.getRealSunStatus() * 3;
  }
  ...
  public boolean onBlockActivated(EntityHuman entityhuman) {
    entityhuman.openGui(mod_EE.getInstance(), GuiIds.COLLECTOR_2, this.world, this.x, this.y, this.z);
    return true;
  }
